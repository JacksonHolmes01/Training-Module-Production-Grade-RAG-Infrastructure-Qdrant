...
1. Retrieve sources from Qdrant
...
- Qdrant finds the nearest vectors
...
The model has **no access to Qdrant**.
...
So Qdrant lives on the internal Docker network.
...
- Qdrant might be managed (cloud service)
