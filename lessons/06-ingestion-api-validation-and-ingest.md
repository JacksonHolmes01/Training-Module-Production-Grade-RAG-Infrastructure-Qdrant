...
- Use `curl` to ingest documents through **NGINX → API → Qdrant**.
...
- HTTP `200`
- JSON response with a Qdrant object id
...
[Lesson 7](https://github.com/JacksonHolmes01/Training-Module-Production-Grade-RAG-Infrastructure-Qdrant/blob/main/lessons/07-rag-retrieval-and-ollama.md)
