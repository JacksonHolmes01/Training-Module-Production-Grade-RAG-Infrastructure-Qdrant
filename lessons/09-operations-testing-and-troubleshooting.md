...
Much of this lesson is a refresher over commands and debugging techniques used throughout this repo. This lesson provides a good base for future knowledge and endeavors in working with RAG chatbots and Qdrant.
...
### Drill B — Stop Qdrant (retrieval fails)
...
Full wipe (deletes Qdrant data + Ollama models):
