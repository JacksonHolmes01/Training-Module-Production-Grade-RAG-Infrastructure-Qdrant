# Lesson 8 — Gradio Chat UI: Talking to Your Qdrant RAG Bot
...
- Explain the request path: **UI → NGINX → FastAPI → Qdrant/Ollama → UI**.
...
- it retrieves relevant docs from Qdrant
...
[Lesson 9](https://github.com/JacksonHolmes01/Training-Module-Production-Grade-RAG-Infrastructure-Qdrant/blob/main/lessons/09-operations-testing-and-troubleshooting.md)
