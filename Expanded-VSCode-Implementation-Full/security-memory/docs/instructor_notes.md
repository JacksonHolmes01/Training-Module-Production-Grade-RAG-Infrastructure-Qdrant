...
3) Have students ingest a security corpus (or use sample corpus).
...
6) Students propose minimal diffs and validate the lab still works.
...
## If you want to keep repo small
